...
function SessionProvider({
  ...
  const idconsultor = react.useMemo(() => idconsultorFromToken(token), [token]);
  const loadConsultant = react.useMemo(
    () => fetchConsultant ?? makeDefaultFetchConsultant(apiBase),
    [fetchConsultant, apiBase]
  );
  const { data: consultant, isLoading } = reactQuery.useQuery({
...
var HostContext = react.createContext(DEFAULT_HOST_CONTEXT);
function HostProvider({ value, children }) {
  return /* @__PURE__ */ jsxRuntime.jsx(HostContext.Provider, { value, children });
}
...
var ModuleErrorBoundary = class extends react.Component {
  state = { error: null };
...
function defaultErrorFallback(error) {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { role: "alert", style: { padding: 24 }, children: [
...
function ModuleSlot({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(HostProvider, { value: { shell: "vo", module, namespace }, children: /* @__PURE__ */ jsxRuntime.jsx(ModuleErrorBoundary, { fallback: errorFallback, children: /* @__PURE__ */ jsxRuntime.jsx(react.Suspense, { fallback: fallback ?? /* @__PURE__ */ jsxRuntime.jsx(DefaultFallback, {}), children }) }) });
}
...
exports.ModuleSlot = ModuleSlot;
exports.SessionProvider = SessionProvider;
exports.TOKEN_KEY = TOKEN_KEY;
exports.consultantQueryKey = consultantQueryKey;
exports.decodeVoJwt = decodeVoJwt;
exports.enabledModules = enabledModules;
exports.federationBuild = federationBuild;
exports.federationBuildTarget = federationBuildTarget;
exports.federationDefaults = federationDefaults;
exports.federationShared = federationShared;
exports.idconsultorFromToken = idconsultorFromToken;
exports.isAdminRoute = isAdminRoute;
exports.isTokenExpired = isTokenExpired;
exports.moduleById = moduleById;
exports.moduleByPath = moduleByPath;
...
exports.voTriggerableRoutes = voTriggerableRoutes;
